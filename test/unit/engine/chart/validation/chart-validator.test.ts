import {ChartValidationRule} from '../../../../../src/interfaces/chart-validation-rule.interface';
...
jest.mock(
  '../../../../../src/engine/chart/validation/rules/has-connection-source-and-target-value',
  () => ({
...
jest.mock(
  '../../../../../src/engine/chart/validation/rules/has-connection-with-condition-or-default',
  () => ({
...
jest.mock(
  '../../../../../src/engine/chart/validation/rules/has-no-source-connection',
  () => ({
...
jest.mock(
  '../../../../../src/engine/chart/validation/rules/has-single-or-multiple-source-connection',
  () => ({
...
jest.mock(
  '../../../../../src/engine/chart/validation/rules/has-single-or-multiple-target-connection',
  () => ({
...
jest.mock(
  '../../../../../src/engine/chart/validation/rules/has-single-source-connection',
  () => ({
...
jest.mock(
  '../../../../../src/engine/chart/validation/rules/is-single-symbol',
  () => ({
